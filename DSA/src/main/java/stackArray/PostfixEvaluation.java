...
//                System.out.println("\nTOP value:"+top+"\n");
    ...
    public double prefixEval(String prefixExpression){
        System.out.println("PreFix Expression:\t"+prefixExpression);
        prefixExpression.replaceAll(" ","");
        StringBuilder editablePrefixExpression = new StringBuilder(prefixExpression);
        prefixExpression = editablePrefixExpression.reverse().toString();
//        System.out.println(postfixExpression);
        postfixExpressionCharArray = prefixExpression.toCharArray();
        stackCapacity = postfixExpressionCharArray.length;
        stack = new int[stackCapacity];
